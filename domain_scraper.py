...
# This code has been copied from a scrapfly.io tutorial: https://scrapfly.io/blog/how-to-scrape-domain-com-au-real-estate-property-data/
...
async def run():
    data = await scrape_properties(
        urls = [
            "https://www.domain.com.au/2002-464-collins-street-melbourne-vic-3000-2019017210",
